...
const Header = props => {
  ...
  <a  rel=" noreferrer" href="https://chatwith.io/s/603cf6d868b78/" target="_blank" className="whatsapp"><FontAwesomeIcon icon={faWhatsapp} size="sm" role="button" aria-label="Whatsapp"/></a>
