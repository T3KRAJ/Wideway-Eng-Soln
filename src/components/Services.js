    ...
    data.allServiceDataJson.edges.forEach((item, index) => {
      serviceArray.push(
        <div
          ...
          className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 xl:max-w-sm lg:w-1/4 w-full mx-auto rounded-3xl shadow-lg bg-white px-12 pt-16 pb-12 text-gray-600"
        ...
        >
          <div className="w-full mb-10 text-center">
            ...
            <p className="text-sm leading-tight h-12">{item.node.desc}</p>
          </div>
        </div>
      )
    })
